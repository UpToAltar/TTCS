...
router.get('/:id', authentication, isAdmin, DoctorController.getDoctorById);
router.put('/update-by-self', authentication, isDoctor, validateUpdateDoctor(), handleValidationErrors, DoctorController.UpdateDoctorBySelf);
router.put('/update-by-admin/:id', authentication, isAdmin, validateUpdateDoctor(), handleValidationErrors, DoctorController.UpdateDoctorByAdmin);
